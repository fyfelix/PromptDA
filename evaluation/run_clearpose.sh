...
Environment overrides:
  ...
  OUTPUT_DIR            Prediction/evaluation output directory. Default: <checkpoint_dir>/clearpose_<checkpoint>_data_d435
...
echo "evaluating PromptDA predictions on ClearPose"
